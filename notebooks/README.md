...
The [lesson guide](../docs/lessons/README.md) contains educational notes for every existing notebook and [detailed plans](../docs/lessons/FUTURE_LESSONS.md) for the next investigations. The notes separate a lesson's construction, visual question, general explanation, finite evidence, and remaining design questions. [Review notes](../docs/lessons/REVIEW_NOTES.md) collect evidence from all ten lessons. [UI discovery notes](../docs/lessons/UI_DISCOVERY_NOTES.md) connect the constructions to declarative choices and separate module responsibilities.
