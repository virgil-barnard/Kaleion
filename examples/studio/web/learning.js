...
const steps=[
  ...
  ['Create your first motion','Counts → Details → Combine. Destination: Markers. Choose Use source values as destination height. Keep source key ↔ target key as key ↔ key and the supplied value as value. Preview, then Apply.','Applying new coordinates records a movement. Dragging an object name only moves its view; it does not record mathematical motion.'],
