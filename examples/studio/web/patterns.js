...
import {relationNotation} from './notation.js';
...
export function lensControls(source,expr,parameters,parse){
  ...
  function rebuild(){
    ...
    function update(){
      ...
      rule=relationNotation(pattern(kind.value,mapping.map(s=>s.value),limit.value),source.fields,parameters,expr,parse);
