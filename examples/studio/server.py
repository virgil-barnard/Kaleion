...
def serve(port=8765):
    ...
    class Handler(BaseHTTPRequestHandler):
        ...
        def do_GET(self):
            ...
            elif self.path in ("/", "/studio.js", "/context.js", "/studio.css", "/canvas.css", "/shell.js", "/creation.js", "/expressions.js", "/groups.js", "/drafts.js", "/coverage.js", "/views.js", "/evidence.js", "/receipts.js", "/cases.js", "/replay.js", "/comparison.js", "/camera.js", "/workspace.js", "/construction.js", "/scene.js", "/document.js", "/patterns.js"):
        ...
        def do_POST(self):
            ...
            try:
                ...
                if self.path == "/api/preview":
                    ...
                    result = studio.capture(body["capture"], revision)
                elif self.path == "/api/construction":
